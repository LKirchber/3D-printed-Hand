...
MOTOR_T Motor2 = { .htim = &htim1, .Channel = TIM_CHANNEL_2, .sConfigOC_Motor = sConfigOC_Motor2, .M_GPIOx = GPIOB, .M_GPIO_Pin = MOTOR2_PH_Pin, };
...
MOTOR_T Motor3 = { .htim = &htim1, .Channel = TIM_CHANNEL_3, .sConfigOC_Motor = sConfigOC_Motor3, .M_GPIOx = GPIOB, .M_GPIO_Pin = MOTOR3_PH_Pin, };
